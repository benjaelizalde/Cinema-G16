...
CREATE TABLE "new_Direccion" (
    ...
    CONSTRAINT "Direccion_cineId_fkey" FOREIGN KEY ("cineId") REFERENCES "Cine" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "new_EntradaPrecio" (
    ...
    CONSTRAINT "EntradaPrecio_cineId_fkey" FOREIGN KEY ("cineId") REFERENCES "Cine" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE "new_Sala" (
    ...
    CONSTRAINT "Sala_cineId_fkey" FOREIGN KEY ("cineId") REFERENCES "Cine" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
